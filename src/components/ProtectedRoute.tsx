  ...
  if (!isAuthenticated || !isAdmin) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-soft p-4">
        <div className="bg-white rounded-xl shadow-xl p-8 max-w-md w-full text-center space-y-6 animate-fade-in">
          <div className="mx-auto bg-red-100 w-16 h-16 rounded-full flex items-center justify-center animate-pulse-slow">
